...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script ='<?= $homeurl ?>/plugins/jQuery/jquery-2.2.3.min.js'></script>
    <script src='<?= $homeurl ?>/plugins/tinymce/tinymce.min.js'></script>
<script src="<?= $homeurl ?>/javascripts/scale.fix.js"></script>
    <script src="<?= $homeurl ?>/javascripts/camvas.js"></script>
    <script src="<?= $homeurl ?>/javascripts/camvas_example.js"></script>
    <style>
        @font-face {
    ...
    <div class='wrapper'>
            ...
            <section class='sidebar'>
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
				 ...
				 <li>
                        ...
                        $rooms = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM meet JOIN meet_has_class ON meet_has_class.id_meet=meet.id WHERE meet_has_class.id_kelas='$siswa[id_kelas]' AND meet.status=true"));
                        ?>
                        <a href='<?= $homeurl ?>/meeting'><i class='fas fa-video fa-fw'></i> Video Conferensi<?= ($rooms > 0) ? '<span class="badge bg-yellow" style="float: right; margin-top: 0;">ON</span>' : '' ?></a>
                    </li>
				<?php } ?>
				<?php if($setting['menu_akm']==1){ ?>
                    <li><a href='<?= $homeurl ?>/jadwal'><i class='fas fa-calendar fa-fw  '></i> <span> Jadwal Ujian</span></a></li>
				<?php } ?>
				<?php if($setting['tarik']==1){ ?>
				<li><a href='<?= $homeurl ?>/sinkron'><i class='fas fa-angle-double-right fa-fw'></i> <span>Tarik Data </span></a></li>
				<li><a href='<?= $homeurl ?>/kirimhasil'><i class='fas fa-angle-double-right fa-fw'></i> <span>Kirim Data Ujian </span></a></li>
				<?php } ?>					
                  ...
                  <li><a href='<?= $homeurl ?>/materi'><i class='fas fa-file fa-fw  '></i> <span> Materi Belajar</span></a></li>
                    ...
                    <li><a href='<?= $homeurl ?>/voting'><i class='fas fa-edit fa-fw  '></i> <span> E-Vote</span></a></li>
					<li><a href='<?= $homeurl ?>/visimisi'><i class='fas fa-users fa-fw  '></i> <span> Visi Misi Calon</span></a></li>
				<?php } ?>
        ...
        <div class='content-wrapper' style='background-image: url(dist/backgroun.jpg);background-size: cover;'>
            ...
            <section class='content' style="margin-top:-95px">
                 <?php if ($pg == '') : ?>
				  <?php if($setting['menu_elearn']==1){ ?>
				   <?php if($setting['absendaring']=='Tanpa Photo'){ ?>
                    <div class='row'>
                        <div class="col-md-6">
                            <div class="box box-solid">
                                <div class='box-header with-border'>
                                    <h3 class='box-title'><i class='fa fa-calendar'></i> Absensi</h3>
                                    <div class='box-tools pull-right'></div>
                                </div><!-- /.box-header -->
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="img-responsive" style="min-height: 225px; position: relative;">
                                        <img src="<?= $homeurl ?>/dist/img/absen/absen-<?= rand(1, 4) ?>.jpg" style="width: 100%; border-radius: 20px; background-color: #ecf0f5;" />
                            ...
                            ?>
											...
											<?= ucwords(strtolower($siswa['nama'])) ?> Belum Absen</p>
											 <?php } ?>
											
                                            <button type="button" class="btn-primary btn btn-block btn-lg">Absen </button>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                       ...
                       <?php } ?>
                      <?php if($setting['absendaring']=='Gunakan Photo'){ ?>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php while ($peringkat = mysqli_fetch_array($nilaix)) : ?>
                                                                    ...
                                                                    <tr <?= $style ?>>
																		...
																		$peringkat['skor'] +$peringkat['skor_esai']+$peringkat['skor_multi']+$peringkat['skor_bs']+$peringkat['urut']
																		?></td>
                                                                    </tr>
                                                                <?php endwhile; ?>
                                                            </tbody>
                ...
                <?php elseif ($pg == 'hasil') : ?>
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class='box box-solid'>
                                <div class='box-header with-border'>
                                    <h3 class='box-title'><i class="fas fa-file-signature    "></i> Data Nilai</h3>
                                </div><!-- /.box-header -->
                                <div class='box-body'>
                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="true">Hasil Tugas</a></li>
											 <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="true">Hasil Quiz</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_1">
											...
											<div class="tab-pane" id="tab_3">
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Daftar Quiz yang sudah dikerjakan</strong>
                                                </div>
                                                <table id='example1' class='table table-bordered table-striped'>
                                                    <thead>
                                                        <tr>
                    ...
                    <?php
                        ...
                        if ($action) {
                            ...
                            $exce = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM meet WHERE status=true"));
                      ...
                      $rooms = mysqli_fetch_all(mysqli_query($koneksi, "SELECT * FROM meet
					  JOIN meet_has_class ON meet_has_class.id_meet=meet.id WHERE meet_has_class.id_kelas='$siswa[id_kelas]' AND meet.status=true"), MYSQLI_ASSOC);
                    ?>
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class='box box-solid'>
                                <div class='box-header with-border'>
                                    <h3 class='box-title'><i class="fas fa-video"></i> Video Conferensi</h3>
                                </div><!-- /.box-header -->
                                <div class='box-body'>
                                            ...
                                            <div class="thumbnail">
                                                <div class="caption bg-info">
                                                    ...
                                                    <div class="btn-group btn-group-lg btn-group-justified" role="group" aria-label="Justified button group">
                                                        <a href="<?= $homeurl ?>/meeting/<?= enkripsi($value['room']) ?>" class="btn btn-block btn-lg btn-info" role="button"><i class="fas fa-video" ></i> &nbsp;Masuk sekarang</a> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

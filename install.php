...
if (isset($_POST['buat2'])) {
	$filename = 'database/siskolah.sql';
	$templine = '';
	$lines = file($filename);
...
<head>
	...
	<title>Installasi SISKOLAH</title>
...
<body class="hold-transition skin-blue layout-top-nav">
	...
	<div class="wrapper">
			...
			<nav class="navbar navbar-fixed-top bg-maroon">
				<div class="container">
					<div class="navbar-header">
						<a href="?" class="animated bounce navbar-brand" style="padding:5px 15px;"><b>E-BELAJAR</b> INSTALLER</a>
					</div>
				</div>
			</nav>
		</header>
		...
		<!-- Full Width Column -->
		<div class="content-wrapper" style="background:url(dist/img/ajax-loader.gif);background-size: cover;">

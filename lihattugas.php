        ...
        <div class='box box-solid'>
            ...
            <div class='box-body'>
                <table class='table table-bordered table-striped'>
					...
					<?php if($tugas['file']<>''){ ?>
					 <tr>
                        <th>Download</th>
                        <td width='10'>:</td>
                        <td> <a href="<?= $homeurl . '/berkas/' . $tugas['file'] ?>" class="btn btn-sm btn-danger"><i class="fas fa-download fa-fw"></i> Download Tugas</a></td>
                    </tr>
					<?php } ?>
                </table>
                <br>
                <div class="nav-tabs-custom">
					...
					?>
					<?php if($ekstensi=='mp4'){ ?>
					<video src="<?= $homeurl ?>/berkas/<?= $tugas['file'] ?>" controls autoplay width="100%" height="315"></video>
					 <?php } ?>
					 <?php if($ekstensi=='jpg' OR $ekstensi=='png'){ ?>
					<img src="<?= $homeurl ?>/berkas/<?= $tugas['file'] ?>" controls autoplay width="100%" height="315">
					 <?php } ?>
					 <?php if($ekstensi=='pdf'){ ?>
					<iframe  src="<?= $homeurl ?>/berkas/<?= $tugas['file'] ?>" controls autoplay width="100%" height="315"></iframe>
					 <?php } ?>
                                <?php } ?>
                                <center>
                                    <h3><?= $tugas['judul'] ?></h3>

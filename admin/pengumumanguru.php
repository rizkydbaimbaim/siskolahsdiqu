                ...
                <div class='box-body'>
                    ...
                    <div class='col-sm-12'>
                        <div class='form-group'>
                            ...
                            <input type='radio' name='tipe' value='internal' > <span class='text-green'><b>guru</b></span> &nbsp; &nbsp;&nbsp;<input type='radio' name='tipe' value='eksternal' checked> <span class='text-blue'><b>siswa</b></span>
                        </div>
                    </div>
                    <div class='col-sm-12'>
                        <div class='form-group'>

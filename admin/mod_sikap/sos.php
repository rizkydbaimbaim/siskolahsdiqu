...
<div class='row'>
        <div class='col-md-12'>
            <div class='box box-solid'>
                <div class='box-header with-border '>
                    <h3 class='box-title'><i class="fas fa-user-friends fa-fw   "></i> Nilai Sikap Sosial</h3>
                    ...
                    <div class='table-responsive'>
                      <table id='tabelsikap' class='table table-bordered table-striped'>
                        ...
                        <tbody>
							...
							$spi=fetch($koneksi,'sosial',['niss' =>$siswa['nis']]);
                                $no++;
                            ?>
                                <tr>
                                    <td><?= $no; ?></td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                        ...
                                                        <div class="modal-header bg-blue">
                                                            <h5 class="modal-title"> SIKAP SOSIAL</h5>
														 ...
														 <form action='' method='post'>
														  <input type="hidden" name="kelas" value="<?= $_GET['kelas'] ?>"> 
														   <input type="hidden" name="id" value="<?= $spi['ids'] ?>"> 
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label><b>Yang selalu dilakukan </b></label>
                                                                 <p><input type="checkbox" name="ket1[]" value="jujur"> jujur
																 <input type="checkbox" name="ket1[]" value="disiplin" > disiplin
																  <input type="checkbox" name="ket1[]" value="tanggung jawab" > tanggung jawab
																  <input type="checkbox" name="ket1[]" value="santun" > santun
																  <input type="checkbox" name="ket1[]" value="percaya diri" > percaya diri
																  <input type="checkbox" name="ket1[]" value="peduli" > peduli
																    <input type="checkbox" name="ket1[]" value="toleransi" > toleransi</p>
                                                            </div>
                                                            
															 <div class="form-group">
                                                                <label><b>Sedang Meningkat</b></label>
	    ...
	    <?php
            ...
            if (isset($_POST['simpan'])) {
                ...
                $ket2 = $_POST['ket2'];
                $pred = $_POST['pred'];
				$exec = mysqli_query($koneksi, "INSERT INTO sosial VALUES('','$nis','$ket1','$ket2','$pred')");
    ...
    echo "
	  <script type='text/javascript'>
		...
		window.setTimeout(function(){ 
			window.location.replace('?pg=nilaisosial&kelas=$kelas');
		} ,2000);	
	  </script>";
			}
				 ?>
  ...
  $('#tabelsikap').on('click', '.hapus', function() {
       var id = $(this).data('id');
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: 'mod_sikap/crud_sikap.php?pg=hapussos',
                    method: "POST",
                    data: 'id=' + id,

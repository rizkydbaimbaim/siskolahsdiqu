   ...
   $kode = str_replace(' ', '', $_POST['kode']);
    ...
    if ($pengawas['level'] == 'admin') {
        ...
        if ($cek > 0) :
           ...
           $exec = mysqli_query($koneksi, "INSERT INTO mapel (kode, idpk, nama,level,status,idguru,kelas,groupsoal) VALUES ('$kode','$id_pk','$nama','$level','$status','$guru','$kelas','$groupsoal')");
...
if ($pg == 'simpan_soal') {
    ...
    if ($jenis == '1') {
        ...
        $jawaban = $_POST['jawaban'];
            ...
            $exec = mysqli_query($koneksi, "UPDATE soal SET soal='$isi_soal',pilA='$pilA',pilB='$pilB',pilC='$pilC',pilD='$pilD',pilE='$pilE',jawaban='$jawaban' WHERE id_soal='$idsoal' AND jenis='1'");
    ...
    if ($jenis == '2') {
        ...
        if ($jumsoal == 0) {
            ...
            $exec = mysqli_query($koneksi, "UPDATE soal SET soal='$isi_soal', jawaban='$pilA' WHERE id_soal='$idsoal' AND jenis='2'");
     ...
     $pilC = addslashes($_POST['pilC']);
      $pilD = addslashes($_POST['pilD']);
       ...
       $jawabane = implode($_POST['jawaban'], ', ');
            ...
            $exec = mysqli_query($koneksi, "UPDATE soal SET soal='$isi_soal',pilA='$pilA',pilB='$pilB',pilC='$pilC',pilD='$pilD',pilE='$pilE',jawaban='$jawabane' WHERE id_soal='$idsoal'");
  ...
  if ($jenis == '4') {
        ...
        $jawabanb = $_POST['jawabana'].', '.$_POST['jawabanb'].', '.$_POST['jawabanc'].', '.$_POST['jawaband'].', '.$_POST['jawabane'];
			...
			$exec = mysqli_query($koneksi, "UPDATE soal SET soal='$isi_soal',pilA='$pilA',pilB='$pilB',pilC='$pilC',pilD='$pilD',pilE='$pilE',jawaban='$jawabanb' WHERE id_soal='$idsoal' AND jenis='4'");
     ...
     $pilC = addslashes($_POST['pilC']);
      $pilD = addslashes($_POST['pilD']);
       ...
       $jawabani = implode($_POST['jwb'], ', ');
            ...
            $exec = mysqli_query($koneksi, "UPDATE soal SET soal='$isi_soal',pilA='$pilA',pilB='$pilB',pilC='$pilC',pilD='$pilD',pilE='$pilE',jawaban='$jawabani' WHERE id_soal='$idsoal' AND jenis='5'");

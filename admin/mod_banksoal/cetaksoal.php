	...
	echo "
		...
		<html>
			...
			echo" <br>
				...
				<h3 class='panel-title'>
				<b>B. Soal Pilihan Ganda Kompleks</b>
				</h3>
				<br/>
			...
			$nomer = 1;
			$sql = mysqli_query($koneksi, "SELECT * FROM soal where id_mapel=$id_mapel and jenis='3' order by nomor");			
			while($sp = mysqli_fetch_array($sql))
			{
				...
				<h3 class='panel-title'>
				<b>C. Soal Pilihan Benar Salah</b>
				</h3>
				<br/>
			...
			$nomer = 1;
			$sql = mysqli_query($koneksi, "SELECT * FROM soal where id_mapel=$id_mapel and jenis='4' order by nomor");			
			while($sp = mysqli_fetch_array($sql))
			{
			...
			$nomer = 1;
			$sql = mysqli_query($koneksi, "SELECT * FROM soal where id_mapel=$id_mapel and jenis='5' order by nomor");			
			while($sp = mysqli_fetch_array($sql))
			{

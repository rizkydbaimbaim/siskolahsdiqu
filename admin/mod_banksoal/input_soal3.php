								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='radio' name='jawabana' value='B' required='true' <?= $jwbA ?> /> Benar</label> <label><input type='radio' name='jawabana' value='S' required='true' <?= $jwbA ?> /> Salah</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='radio' name='jawabanb' value='B' required='true' $jwbB /> Benar</label><label><input type='radio' name='jawabanb' value='S' required='true' $jwbB /> Salah</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='radio' name='jawabanc' value='B' required='true' $jwbC /> Benar</label><label><input type='radio' name='jawabanc' value='S' required='true' $jwbC /> Salah</label>
											</div>
										</div>
									...
									";
										...
										<div class='panel box box-solid'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													<label><input type='radio' name='jawaband' value='B' required='true' $jwbD /> Benar</label><label><input type='radio' name='jawaband' value='S' required='true' $jwbD /> Salah</label>
												</div>
											</div>
										...
										<div class='panel box box-solid'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													<label><input type='radio' name='jawabane' value='B' required='true' $jwbE /> Benar</label><label><input type='radio' name='jawabane' value='S' required='true' $jwbE /> Salah</label>
												</div>
											</div>

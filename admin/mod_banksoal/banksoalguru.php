                        ...
                        <table id='example1' class='table table-bordered table-striped'>
                            ...
                            <tbody>
                                ...
                                elseif ($pengawas['level'] == 'guru') :
                                    $mapelQ = mysqli_query($koneksi, "SELECT * FROM mapel WHERE idguru='$_SESSION[id_pengawas]' ORDER BY date ASC");
                                endif;
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><small class='label label-primary'><?= $no ?></small></td>
                                           ...
                                           <td><?= $mapel['nama'] ?></td>
                                            ...
                                            $guruku = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM pengawas WHERE id_pengawas = '$_SESSION[id_pengawas]'"));
                                            ?>
											 <?= $status ?>
                                                  </td>
												  <td><?= $guruku['nama'] ?></td>
                            ...
                            <div class="col-md-6">
                                <div class='form-group'>
                                    ...
                                    <select name='nama' class='form-control' required='true'>
                                         <option value=''></option>
                                                                        <?php
                                                                        $pkQ = mysqli_query($koneksi, "SELECT * FROM mata_pelajaran JOIN jadwal_mapel  ON jadwal_mapel.kode=mata_pelajaran.kode_mapel WHERE jadwal_mapel.guru='$_SESSION[id_pengawas]' ORDER BY nama_mapel ASC");
                                ...
                                <?php if ($pengawas['level'] == 'guru') : ?>
                                    <div class='col-md-6'>
                                        ...
                                        <select name='guru' class='form-control' required='true'>
                                            <?php
                                            $guruku = mysqli_query($koneksi, "SELECT * FROM pengawas where level='guru' AND id_pengawas='$_SESSION[id_pengawas]' order by nama asc");

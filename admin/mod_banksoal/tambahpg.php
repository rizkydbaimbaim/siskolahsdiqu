...
$exec = mysqli_query($koneksi, "UPDATE mapel SET opsi='5'"); 
$jenis = 'pg';
$id_mapel = $_GET['id'];
...
<div class='row'>
	<div class='col-md-12'>
		<form id='formsoal' action='mod_banksoal/crud_banksoal' method='post' enctype='multipart/form-data'>
			<div class='box box-solid'>
				...
				<div class='box-body'>
					<input type='text' name='mapel' value='<?= $id_mapel ?>'>
						...
						<div class='btn-group'>
							...
							if ($jenis == 'pg') {
								for ($i = 1; $i <= $mapel['jml_soal']; $i++) {
									$ceksoal = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM soal WHERE id_mapel='$id_mapel' AND nomor='$i' AND jenis='pg'"));

                            ...
                            <tbody>
                                ...
                                <?php while ($tugas = mysqli_fetch_array($tugasQ)) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <div class=''>
                                                <a href='?pg=tugasadmin&ac=jawaban&id=<?= $tugas['id_tugas'] ?>' class='btn btn-sm btn-success '><i class='fas fa-eye'></i> Lihat</a>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($jumlah==0){ ?>
										<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalnilai<?= $no ?>" disabled>
										...
										<?php } ?>
                                        <button data-id='<?= $jawab['id_jawaban'] ?>' class="hapus btn btn-danger btn-sm" disabled><i class="fas fa-trash-alt    "></i></button>
                                        <!-- Modal -->

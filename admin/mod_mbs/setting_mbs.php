                                        ...
                                        <div class='row'>
                                            <div class='col-md-5'>
                                                <div class='checkbox'>
                                                   ...
                                                   <small class='label label-success'>Pilih Data MBS</small><br />
                                                   <label><input type='checkbox' name='data[]' value='nilai_harian' /> Data Nilai Harian</label><br />
                                                      <label><input type='checkbox' name='data[]' value='kode' /> Kode Nilai</label><br />
													   <label><input type='checkbox' name='data[]' value='absen_mapel' /> Absen Mapel</label><br />
													   <label><input type='checkbox' name='data[]' value='agenda' /> Agenda Guru</label><br />
                                                      <label><input type='checkbox' name='data[]' value='jurnal' /> Jurnal Guru</label><br />
													   <label><input type='checkbox' name='data[]' value='absen_guru' /> Absensi Guru</label><br />
													   <label><input type='checkbox' name='data[]' value='jadwal_mapel' /> Jadwal_mapel</label><br />
                                                </div>
                                            </div>
                                            <div class='col-md-7'>

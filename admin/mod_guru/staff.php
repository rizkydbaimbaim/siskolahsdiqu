    ...
    <div class='col-md-8'>
        <div class='box box-solid'>
            <div class='box-header with-border'>
                <h3 class='box-title'>Manajemen Staff</h3>
            ...
            <div class='box-body'>
                <div class='table-responsive'>
                    <table id='example1' class='table table-bordered table-striped'>
                        ...
                        <tbody>
                            <?php $guruku = mysqli_query($koneksi, "SELECT * FROM pengawas where level='staff' ORDER BY nama ASC"); ?>
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($cekuser > 0) {
                    ...
                    if ($pass1 <> $pass2) {
                        ...
                        $password = $pass1;
                        $exec = mysqli_query($koneksi, "INSERT INTO pengawas (nip,nama,username,password,level) VALUES ('$nip','$nama','$username','$password','staff')");
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($pass1 <> '' and $pass2 <> '') {
                    if ($pass1 <> $pass2) {
                        ...
                        $password = $pass1;
                        $exec = mysqli_query($koneksi, "UPDATE pengawas SET nip='$nip',nama='$nama',username='$username',password='$password',level='staff' WHERE id_pengawas='$id'");
                    }
                } else {
                    $exec = mysqli_query($koneksi, "UPDATE pengawas SET nip='$nip',nama='$nama',username='$username',level='staff' WHERE id_pengawas='$id'");
                }
                (!$exec) ? $info = info("Gagal menyimpan!", "NO") : jump("?pg=$pg");
            }
            ?>

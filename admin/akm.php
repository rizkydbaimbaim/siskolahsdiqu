		...
		<aside class='main-sidebar' style="background-color: #000000">
			...
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					<li style="color:#ffff" class="header">MENU CBT-AKM</li>
					<?php if ($pengawas['level'] == 'admin') : ?>
						<?php if ($setting['server'] == 'lokal') : ?>
							<li class=' treeview'>
								<a href='#'>
						...
						<?php if ($setting['server'] == 'pusat') : ?>
							<li class=' treeview'>
								...
								<ul class='treeview-menu'>
									...
									<li><a style="color:#FFFFFF" href='?pg=jenisujian'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data Jenis Ujian</span></a></li>

									<?php if ($setting['jenjang'] == 'SMK') : ?>
										<li><a style="color:#fff" href='?pg=pk'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data Jurusan</span></a></li>
									<?php endif ?>

									<li><a style="color:#fff" href='?pg=kelas'><i class='fa fa-angle-double-right fa-fw'></i> <span> Data Kelas</span></a></li>
									<?php if($setting['menu_akm']==1){ ?>
									<li><a style="color:#fff" href='?pg=ruang'><i class='fa fa-angle-double-right fa-fw'></i> <span> Data Ruangan</span></a></li>
									<li><a style="color:#fff" href='?pg=level'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data Level</span></a></li>
									<li><a style="color:#fff" href='?pg=sesi'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data Sesi</span></a></li>
									<li><a style="color:#fff" href='?pg=dataserver'><i class='fas fa-angle-double-right fa-fw'></i> <span> Data Server</span></a></li>
								<?php } ?>
								</ul>
							</li>
							
						<?php endif ?>
						<li class='treeview'><a style="color:#ffff" href='?pg=siswa'><i style="color:#ffff" class="fas fa-user-friends side-menu-icon fa-fw   "></i> <span>Peserta Ujian</span></a></li>
						
						<li class='treeview'>
							<a style="color:#ffff" href='#'><i style="color:#ffff" class="fas fa-envelope-open-text side-menu-icon fa-fw"></i><span> Bank Soal </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
								<li><a style="color:#ffff" href='?pg=banksoal'><i style="color:#ffff" class='fas fa-angle-double-right fa-fw'></i> <span> Daftar Soal</span></a></li>
								<li><a style="color:#ffff" href='?pg=filependukung'><i style="color:#ffff" class='fas fa-angle-double-right  fa-fw'></i> <span>File Pendukung</span></a></li>

							</ul>
						</li>
						<li><a style="color:#ffff" href='?pg=statusall'><i style="color:#ffff" class="fas fa-user-friends side-menu-icon fa-fw    "></i> <span>Status Peserta</span></a></li>
						<!-- <li><a href='?pg=jadwal'><i class="fas fa-desktop side-menu-icon fa-fw"></i> <span> Status Ujian</span></a></li> -->
						<li class='treeview'>
							<a style="color:#ffff" href='#'><i style="color:#ffff" class="fas fa-desktop side-menu-icon fa-fw"></i><span> Menu Ujian </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
								<li><a style="color:#ffff" href='?pg=jadwal'><i style="color:#ffff" class='fas fa-angle-double-right fa-fw'></i> <span> Jadwak Ujian</span></a></li>
								<li><a style="color:#ffff" href='?pg=reset'><i style="color:#ffff" class='fas fa-angle-double-right  fa-fw'></i> <span>Reset Ujian</span></a></li>

							</ul>
						</li>

						<li class='treeview'>
							<a style="color:#ffff" href='#'><i style="color:#ffff" class="fas fa-file-signature side-menu-icon fa-fw"></i><span> Nilai </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
								<li><a style="color:#ffff" href='?pg=nilaiujian'><i style="color:#ffff" class='fas fa-angle-double-right fa-fw'></i> <span> Hasil Nilai</span></a></li>
								<li><a style="color:#ffff" href='?pg=semuanilai'><i style="color:#ffff" class='fas fa-angle-double-right  fa-fw'></i> <span>Semua Nilai</span></a></li>
								<?php if ($setting['server'] == 'lokal') : ?>
									<li><a style="color:#ffff" href='?pg=dataujian'><i style="color:#ffff" class='fas fa-angle-double-right fa-fw'></i> <span>Kirim Nilai</span></a></li>
								<?php endif ?>
							</ul>
						</li>
						<li class='treeview'>
							<a style="color:#ffff" href='#'><i style="color:#ffff" class="fas fa-print side-menu-icon fa-fw"></i><span> Cetak </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
								<li><a style="color:#ffff" href='?pg=absen'><i style="color:#ffff" class='fas fa-angle-double-right fa-fw'></i> <span> Daftar Hadir</span></a></li>
								<li><a style="color:#ffff" href='?pg=kartu'><i style="color:#ffff" class='fas fa-angle-double-right fa-fw'></i> <span> Cetak Kartu</span></a></li>
								<li><a style="color:#ffff" href='?pg=berita'><i style="color:#ffff" class='fas fa-angle-double-right fa-fw'></i> <span> Berita Acara</span></a></li>
							</ul>
						</li>

						<li class=' treeview'>
								<a style="color:#fff" href='#'>
									<i style="color:#fff" class="fas fa-sync-alt side-menu-icon fa-fw    "></i>
									<span>Sinkron Kirim Data </span>
									<span class='pull-right-container'>
										<i class='fa fa-angle-down pull-right'></i>
									</span>
								</a>
								<ul class='treeview-menu'>
									<li><a style="color:#fff" href='?pg=sinkronset'><i class='fas fa-angle-double-right fa-fw'></i> <span> Sinkron Setting</span></a></li>
									<li><a style="color:#fff" href='?pg=kirimbank'><i class='fas fa-angle-double-right fa-fw'></i> <span> Kirim Bank Soal ke Hosting</span></a></li>
								<li><a style="color:#fff" href='?pg=kirimsoal'><i class='fas fa-angle-double-right fa-fw'></i> <span> Kirim Soal ke Hosting</span></a></li>

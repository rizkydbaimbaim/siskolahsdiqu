            ...
            <div class='box-body'>
                    <div class='table-responsive'>
                      <table id='tabelwalas' class='table table-bordered table-striped'>
                        ...
                        <tbody>
                            <?php
                            $query = mysqli_query($koneksi, "select * from siswa_rapor WHERE kelas='$_GET[kelas]' order by id ASC");
                            $no = 0;
                                                ...
                                                <div class="modal-content">
                                                    <form id="form-des<?= $no ?>">
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <input type="hidden" value="<?= $siswa['nis'] ?>" name="nis" class="form-control" > <input type="text" name="ket"  class="form-control"  required>         
                                                            </div>

...
<body style="font-size: 12px;">
   ...
   <div style="padding-left:20px;margin-right:50px ;" class="col-md-12">
	...
	<th style="text-align: center;">Nama Siswa</th>
	 <?php
			$querys = mysqli_query($koneksi,"select * from kode WHERE ket='1' AND mapel='$mapel'");
     ...
     <tbody>
			...
			WHERE idsiswa='$siswa[id]' AND kode.ket='1' AND mapel='$mapel' GROUP  BY idkode");
     	...
     	<td style="text-align: center;"><?= round($nilai['nkd']) ?></td>
			...
			JOIN kode ON kode.id=nilai_harian.idkode
			WHERE idsiswa='$siswa[id]' AND kode.ket='1' AND mapel='$mapel'");

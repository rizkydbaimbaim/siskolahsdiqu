		...
		<aside class='main-sidebar' style="background-color: #000000">
			...
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					<li style="color:#fff" class="header">MENU E - LEARN</li>
					<?php if ($pengawas['level'] == 'admin') : ?>
                        ...
                        <li class='treeview'><a style="color:#fff" href='index.php'><i style="color:#fff" class="fas fa-home side-menu-icon fa-fw"></i> <span> Home</span></a></li>
						 <li class='treeview'><a style="color:#fff" href='?pg=setting_learn'><i style="color:#fff" class="fas fa-tools side-menu-icon fa-fw"></i><span> Pengaturan</span></a></li>
						<?php if($setting['menu_elearn']==1){ ?>
                        <li class='treeview'>
							<a style="color:#fff" href='#'><i style="color:#fff" class="fas fa-edit side-menu-icon fa-fw"></i><span> E-Learning </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
						...
						<?php } ?>
						<li class='treeview'><a style="color:#fff" href='?pg=absendaringkelas'><i style="color:#fff" class="fas fa-print side-menu-icon fa-fw"></i><span> Absen Daring</span></a></li>
					<?php endif ?>

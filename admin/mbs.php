		...
		<aside class='main-sidebar' style="background-color: #000000">
			...
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					<li style="color:#fff" class="header">MENU MBS</li>
					<?php if ($pengawas['level'] == 'admin') : ?>
                         ...
                         <li class='treeview'><a style="color:#fff" href='?pg=setting_mbs'><i style="color:#fff" class="fas fa-tools side-menu-icon fa-fw"></i><span> Pengaturan</span></a></li>
						<li class='treeview'><a style="color:#fff" href='?pg=jadwalmapel'><i style="color:#fff" class="fas fa-users side-menu-icon fa-fw"></i><span> Jadwal Mengajar</span></a></li>
						<?php if($setting['absen']=='QR Code'){ ?>
						<li class='treeview'><a style="color:#fff" href='?pg=abqr'><i style="color:#fff" class="fas fa-camera side-menu-icon fa-fw"></i><span> Buat QR Code</span></a></li>
						<?php } ?>
						<?php if($setting['absen']=='Manual'){ ?>
						<li class='treeview'><a style="color:#fff" href='?pg=abmanual'><i style="color:#fff" class="fas fa-edit side-menu-icon fa-fw"></i><span> Input Absen Guru</span></a></li>
						<?php } ?>
						
						<li class='treeview'>
							<a style="color:#fff" href='#'><i style="color:#fff" class="fas fa-print side-menu-icon fa-fw"></i><span> Cetak Data </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
								<li><a style="color:#fff" href='?pg=datamplab'><i class='fas fa-angle-double-right fa-fw'></i> <span> Cetak Absensi Mapel</span></a></li>
								<li><a style="color:#fff" href='?pg=dataabkelas'><i class='fas fa-angle-double-right fa-fw'></i> <span> Cetak Absensi Kelas</span></a></li>
								<li><a style="color:#fff" href='?pg=datamplag'><i class='fas fa-angle-double-right  fa-fw'></i> <span>Cetak Agenda Guru</span></a></li>
                                 <li><a style="color:#fff" href='?pg=datampljur'><i class='fas fa-angle-double-right  fa-fw'></i> <span>Cetak Jurnal Guru</span></a></li>
						         <?php if($setting['absen']=='Manual'){ ?>
								 ...
								 <li><a style="color:#fff" href='?pg=dataabsenguru'><i class='fas fa-angle-double-right  fa-fw'></i> <span>Cetak Absen Guru</span></a></li>
								 <?php } ?>
								   <li><a style="color:#fff" href='?pg=mbs_cetakph'><i class='fas fa-angle-double-right  fa-fw'></i> <span>Cetak Penilaian Harian</span></a></li>
						</ul>
						</li>
						<li class='treeview'><a style="color:#fff" href='?pg=biodata'><i style="color:#fff" class="fas fa-graduation-cap side-menu-icon fa-fw"></i><span> Biodata Siswa</span></a></li>
					
						<li class='treeview'><a style="color:#fff" href='?pg=nisn'><i style="color:#fff" class="fas fa-user side-menu-icon fa-fw"></i><span> Cetak Kartu Pelajar</span></a></li>

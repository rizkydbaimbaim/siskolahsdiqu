        ...
        <div class='col-md-12'>
            <div class='box box-solid'>
                <div class='box-header with-border '>
                    <h3 class='box-title'><i class="fas fa-edit fa-fw   "></i> NILAI PENGETAHUAN (KI-3)</h3>
            ...
            <div class='box-body'>
                   <div class='table-responsive'>
                        ...
                        <tbody>
							...
							$jumlah = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM nilai_ph WHERE mapel='$mapel[kode]' AND kelas='$mapel[kelas]'"));
                            ...
                            ?>
                                <tr>
									...
									<td>
									<?php if($mapel['agama']==1){ ?>
									<a href="?pg=nilaispiritual&kelas=<?= $mapel['kelas'] ?>" class="btn btn-sm btn-primary btn-rounded" >
                                          <i class="fas fa-edit"></i></button></a>
										<?php } ?>
										</td>
									<td>
									<?php if($mapel['ppkn']==1){ ?>
									<a href="?pg=nilaisosial&kelas=<?= $mapel['kelas'] ?>" class="btn btn-sm btn-primary btn-rounded" >
                                          <i class="fas fa-edit"></i></button></a>
										<?php } ?>
										</td>
                                    <td>
									<a href="mod_ki3/proses.php?id=<?= $mapel['id_jadwal'] ?>" class="btn btn-sm btn-warning btn-rounded" >
                                       ...
                                       <button type="button" class="btn btn-sm btn-success btn-rounded" data-toggle="modal" data-target="#modal-des">
										...
										<?php } ?>
										    ...
										    <td>
									<a href="?pg=viewnilai3&id=<?= $mapel['id_jadwal'] ?>" class="btn btn-sm btn-info btn-rounded" >
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                        ...
                                                        <div class="modal-header bg-blue">
                                                            <h5 class="modal-title"> NILAI (KI-3)</h5>

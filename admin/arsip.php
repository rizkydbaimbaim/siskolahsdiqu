		...
		<aside class='main-sidebar' style="background-color: #000000">
			...
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					<li style="color:#fff" class="header">MENU ARSIP</li>
					<?php if ($pengawas['level'] == 'admin') : ?>
                         ...
                         <li class='treeview'><a style="color:#fff" href='?pg=setting_arsip'><i style="color:#fff" class="fas fa-tools side-menu-icon fa-fw"></i><span> Pengaturan</span></a></li>
						
						<li class='treeview'>
							<a style="color:#fff" href='#'><i style="color:#fff" class="fas fa-edit side-menu-icon fa-fw"></i><span> Data Master </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
						...
						<li class='treeview'>
							<a style="color:#fff" href='#'><i style="color:#fff" class="fas fa-envelope side-menu-icon fa-fw"></i><span> Dokumen </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>

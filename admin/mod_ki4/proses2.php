...
$spreadsheet->getActiveSheet()->getColumnDimension('M')->setWidth(0); 


$spreadsheet->getActiveSheet()->setTitle('KI-4-'.$mapel);
...
header("Content-Disposition: attachment; filename=$ms[kode] KI-4 kelas $klas.xlsx");

            ...
            <div class='modal-body'>
                <form id="formtambahujian" method='post'>
                   ...
                   <?php if ($setting['jenjang'] == 'SD' OR $setting['jenjang'] == 'SMP') : ?>
					 <input type='hidden' name='opsi' value='4'>
					  <?php endif; ?>
					  <?php if ($setting['jenjang'] == 'SMA' OR $setting['jenjang'] == 'SMK') : ?>
					 <input type='hidden' name='opsi' value='5'>
					  <?php endif; ?>
                    ...
                    <div class='form-group'>
                        <label></label><br>
                        <label>
                            <input type='checkbox' class='icheckbox_square-green' name='acak' value='1' disabled /> Acak Soal
                        </label>
                        <label>
                            <input type='checkbox' class='icheckbox_square-green' name='acakopsi' value='1' disabled /> Acak Opsi
                        </label>
                        <label>
                            <input type='checkbox' class='icheckbox_square-green' name='token' value='1' disabled /> Token Soal
                        </label>

                            ...
                            <tbody>
                                ...
                                <?php while ($materi = mysqli_fetch_array($materiQ)) : ?>
                                    ...
                                    <tr>
										...
										<a href="?pg=quizbank&id=<?= $materi[id_materi] ?>" class='btn btn-sm btn-warning' title="Soal"><i class='fas fa-plus'></i></a>
										<?php }else{ ?>
                                        ...
                                        <td style="text-align:center">
                                            <div class=''>
											<a href='?pg=materi&ac=absen&id=<?= $materi['id_materi'] ?>' class='btn btn-sm btn-warning ' title="Absen"><i class='fas fa-user'></i></a>
											<a href='?pg=materi&ac=nilai&id=<?= $materi['id_materi'] ?>' class='btn btn-sm btn-info ' title="Nilai"><i class='fas fa-book'></i></a>
                                                <a href='?pg=materi&ac=lihat&id=<?= $materi['id_materi'] ?>' class='btn btn-sm btn-success ' title="Komen"><i class='fas fa-comment'></i></a>
                                                <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modaledit<?= $materi['id_materi'] ?>" title="Edit">
                                                    <i class="fas fa-edit    "></i>
                                                </button>


                                                <button data-id='<?= $materi['id_materi'] ?>' class="hapus btn btn-danger btn-sm" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class='box box-solid'>
                <div class='box-header with-border '>
                    <h3 class='box-title'> Daftar Komentar Siswa</h3>
						  <div class='box-tools pull-right '>
                        <a href="?pg=materi" class="btn btn-primary mb-5" >
                      ...
                      <div id='tablekomentar' class='table-responsive'>
                        <table id="tabelkomen" class='table table-bordered table-striped  table-hover'>
                            ...
                            <tbody>
								...
								$no=0;
								 if ($pengawas['level'] == 'guru') :
                              $materiQ = mysqli_query($koneksi, "SELECT * FROM komentar WHERE guru='$_SESSION[id_pengawas]' ");
                            elseif ($pengawas['level'] == 'guru') :
							 $materiQ = mysqli_query($koneksi, "SELECT * FROM komentar WHERE guru='$pengawas[id_pengawas]' ");
							  endif;
						   while ($komentar = mysqli_fetch_array($materiQ)){
                              ...
                              $no++;
								...
								<tr>
									   ...
									   <td><?= $komentar['tgl'] ?> </td>
									   <td>
									   <button data-id='<?= $komentar['id'] ?>' class="hapus btn btn-danger btn-sm"><i class="fas fa-trash-alt    "></i></button>
								        </td>
								</tr>
							<?php } ?>
					</tbody>
            ...
            <div class='box box-solid'>
                <div class='box-header with-border '>
					...
					<div class='box-tools pull-right '>
						...
						<a target="_blank" href="mod_elearn/quiz/cetaknilaiquiz.php?id= <?= $_GET['id']; ?>" class="btn btn-danger mb-5" >

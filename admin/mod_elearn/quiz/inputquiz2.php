		...
		<div class='box box-solid'>
				<div class='box-header with-border bg-blue'>
					...
					<div class='box-tools pull-right btn-group'>
						...
						<button type='submit' name='simpanmulti' onclick="tinyMCE.triggerSave(true,true);" class='btn btn-sm btn-primary'><i class='fa fa-check'></i> Simpan</button>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											<h4 class='box-title'>
												<a data-toggle='collapse' data-parent='#accordion' href='#collapseA' aria-expanded='false' class='collapsed'>
													PILIHAN JAWABAN A
												</a>
											</h4>
											<div class='box-tools pull-right'>
												<label><input type='checkbox' name='jawaban[]' value='A'  /> Pilihan A</label>
											</div>
										</div>
										...
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' name='jawaban[]' value='B'  /> Pilihan B</label>
											</div>
										</div>
										...
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' name='jawaban[]' value='C'  /> Pilihan C</label>
											</div>
										</div>
										...
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' name='jawaban[]' value='D'   /> Pilihan D</label>
											</div>
										</div>
										...
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' name='jawaban[]' value='E'   /> Pilihan E</label>
											</div>
										</div>
			...
			mysqli_query($koneksi, "INSERT INTO soal_quiz (idmateri,nomor,kode,soal,pilA,pilB,pilC,pilD,pilE,jawaban) VALUES ('$id_materi','$nomor','2','$soal','$pilA','$pilB','$pilC','$pilD','$pilE','$jawaban')");

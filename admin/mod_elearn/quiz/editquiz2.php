		...
		<div class='box box-solid'>
				<div class='box-header with-border bg-blue'>
					...
					<div class='box-tools pull-right btn-group'>
						...
						<button type='submit' name='simpaneditmulti' onclick="tinyMCE.triggerSave(true,true);" class='btn btn-sm btn-primary'><i class='fa fa-check'></i> Simpan</button>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											<h4 class='box-title'>
												<a data-toggle='collapse' data-parent='#accordion' href='#collapse<?= $soal['id_bank']+1 ?>' aria-expanded='false' class='collapsed'>
													PILIHAN JAWABAN A
												</a>
											</h4>
										...
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' <?php in_array ('E', $checked) ? print "checked" : ""; ?> name='jawaban[]' value='E'   /> Pilihan E</label>
											</div>
										</div>
				...
				<?php
                if (isset($_POST['simpaneditmulti'])) {
	              $idbank=$_POST['idbank'];

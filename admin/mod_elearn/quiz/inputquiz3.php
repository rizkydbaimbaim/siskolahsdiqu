		...
		<div class='box box-solid'>
				<div class='box-header with-border bg-blue'>
					...
					<div class='box-tools pull-right btn-group'>
						...
						<button type='submit' name='simpanesay' onclick="tinyMCE.triggerSave(true,true);" class='btn btn-sm btn-primary'><i class='fa fa-check'></i> Simpan</button>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											<h4 class='box-title'>
												<a data-toggle='collapse' data-parent='#accordion' href='#collapseES' aria-expanded='false' class='collapsed'>
													Kunci Jawaban
												</a>
											</h4>
											
										</div>
										<div id='collapseES' class='panel-collapse collapse' aria-expanded='false' style='height: 0px;'>
											<div class='box-body'>
												<div class='form-group'>
													<textarea name='jawaban' rows='10' cols='80'></textarea>
												</div>                  
                                                  </div>  
												    </div>
													 </div>  
				...
				<?php
                if (isset($_POST['simpanesay'])) {
	             $id_materi=$_POST['id_materi'];
				 $nomor=$_POST['nomor'];
				 $soal=$_POST['isi_soal'];
				
					 $jawaban=$_POST['jawaban'];
			mysqli_query($koneksi, "INSERT INTO soal_quiz (idmateri,nomor,kode,soal,jawaban) VALUES ('$id_materi','$nomor','3','$soal','$jawaban')");

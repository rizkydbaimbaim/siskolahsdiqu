  ...
  <div class='col-md-12'>
            <div class='box box-solid'>
                <div class='box-header with-border '>
                    <h3 class='box-title'><i class="fas fa-print fa-fw   "></i> Absensi <?= $mapel ?> Kelas <?= $kelas ?></h3>
				   ...
				   <button class='btn btn-sm btn-flat btn-primary' onclick="frames['frameresult'].print()"><i class='fa fa-print'></i> Rekap Absen</button>
                    <a href='?pg=inputabsen' class='btn btn-sm bg-maroon' title='Batal'><i class='fa fa-times'></i></a>
		  </div>
         </div>
            <div class='box-body'>
...
<iframe id='loadframe' name='frameresult' src='mod_cetak/cetakrekapabsen.php?id=<?= $_GET['id'] ?>' style='display:none'></iframe>
   ...
   <?php
	  ...
	  <script type='text/javascript'>
		...
		window.setTimeout(function(){ 
		 ...
		 $exec = mysqli_query($koneksi, "INSERT INTO lemari(kode,nama_lemari,dibuat,tanggal,untuk) VALUES('$kode','$nama','$guru','$tanggal','$untuk')");			   
                   echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
        ...
        <div class='col-md-8'>
            <div class='box box-solid'>
                ...
                <?php
                $hariQ = mysqli_query($koneksi, "SELECT * FROM lemari");
                            ...
                            <div class="col-md-6">
                                <div class="box box-widget widget-user-2">
                                    ...
                                    <div class="widget-user-header bg-aqua" style="padding: 6px">
                                      ...
                                      <?php
                $mapelQ = mysqli_query($koneksi, "SELECT * FROM lemari WHERE kode='$hari[kode]' ");

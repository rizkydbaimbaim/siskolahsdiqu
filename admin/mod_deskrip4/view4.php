        ...
        <div class='col-md-12'>
            <div class='box box-solid'>
                <div class='box-header with-border '>
                    <h3 class='box-title' style="color: red"> <?= $mapel ?> (KI-4)</h3>
                    <div class='box-tools pull-right'>
				    <a href="?pg=deskrip4" class="btn btn-sm btn-primary btn-rounded" >
            ...
            <div class='box-body'>
                   <div class='table-responsive'>
                        ...
                        <tbody>
                            <?php
                            $query = mysqli_query($koneksi, "select * FROM deskripsi_4  WHERE mapel='$mapel' AND kelas='$kelas'");
                            $no = 0;
							...
							<div class="modal fade" id="modal-des<?= $no ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                ...
                                <script>
                                    $('#form-des<?= $no ?>').submit(function(e) {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: 'mod_deskrip4/crud_deskripsi.php?pg=ubah',
                                            data: $(this).serialize(),
    ...
    $('#tabeldeskrip').on('click', '.hapus', function() {
       var id = $(this).data('id');
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: 'mod_deskrip4/crud_deskripsi.php?pg=hapus',
                    method: "POST",
                    data: 'id=' + id,
                    success: function(data) {
                        iziToast.error({

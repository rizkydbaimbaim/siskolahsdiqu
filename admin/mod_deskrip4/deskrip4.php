        ...
        <div class='col-md-12'>
            <div class='box box-solid'>
                <div class='box-header with-border '>
                    <h3 class='box-title'><i class="fas fa-edit fa-fw   "></i> DESKRIPSI KETERAMPILAN (KI-4)</h3>
                   ...
                   <div class='table-responsive'>
                        ...
                        <tbody>
                            ...
                            while ($mapel = mysqli_fetch_array($query)) {
									$jumlah = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM deskripsi_4 WHERE mapel='$mapel[kode]' AND kelas='$mapel[kelas]'"));
                                $no++;
                            ?>
                                <tr>
                                    <td><?= $no; ?></td>
									...
									<a href="mod_deskrip4/prosesd4.php?id=<?= $mapel['id_jadwal'] ?>" class="btn btn-sm btn-warning btn-rounded" >
                                       ...
                                       <button type="button" class="btn btn-sm btn-success btn-rounded" data-toggle="modal" data-target="#modal-des">
										...
										<?php } ?>
										    ...
										    <td>
									<a href="?pg=view4&mapel=<?= $mapel['kode'] ?>&kelas=<?= $mapel['kelas'] ?>" class="btn btn-sm btn-info btn-rounded" >
...
<script>
    ...
    $('#form-import').on('submit', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: 'mod_deskrip4/crud_deskrip.php',

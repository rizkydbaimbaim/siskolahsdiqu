                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $siswa['nama'] ?></td>
									 <td>
										   <a target="_blank" href="mod_walas/print_cover.php?nis=<?= $siswa['nis'] ?>" class="btn btn-sm btn-success btn-rounded">
                                          <i class="fas fa-print"></i></button></a>                                        
										   </td>
									<td>
										   <a target="_blank" href="mod_walas/print_biodata.php?nis=<?= $siswa['nis'] ?>" class="btn btn-sm btn-primary btn-rounded">
                                          <i class="fas fa-print"></i></button></a>                                        
										   </td>
                                         <td>
										   <a target="_blank" href="mod_walas/print_raport.php?nis=<?= $siswa['nis'] ?>" class="btn btn-sm btn-danger btn-rounded">
                                          <i class="fas fa-print"></i></button></a>                                        
										   </td>
<?php
                                    }

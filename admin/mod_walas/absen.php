        ...
        <div class='col-md-12'>
            <div class='box box-solid'>
                <div class='box-header with-border '>
                    <h3 class='box-title'><i class="fas fa-user-friends fa-fw   "></i> Absensi</h3>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
									...
									<td><?= $siswa['alpha'] ?></td>
                                     <td>
										<button type="button" class="btn btn-sm btn-success btn-rounded" data-toggle="modal" data-target="#modal-des<?= $no ?>">
                                                ...
                                                <div class="modal-content">
                                                    <form id="form-des<?= $no ?>">
                                                        <div class="modal-header bg-maroon">
                                                            <h5 class="modal-title">Absensi <?= $siswa['nama'] ?></h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Sakit</label>
                                                                <input type="number" name="sakit" value="<?= $siswa['sakit'] ?>" class="form-control" required="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Izin</label>
                                                                <input type="number" name="izin" value="<?= $siswa['izin'] ?>" class="form-control" required="">
                                                            </div>
															<div class="form-group">
                                                                <label>Alpha</label>
                                                                <input type="number" name="alpha" value="<?= $siswa['alpha'] ?>" class="form-control" required="">
                                                            </div>
                                  ...
                                  <script>
                                   $('#form-des<?= $no ?>').submit(function(e) {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: 'mod_walas/crud_walas.php?pg=absen',
                                            data: $(this).serialize(),
